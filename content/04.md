...
Gracias a este nuevo “$r \bar{o} maji$ $hispanizado$" ($\mathtt{r \bar{o} maji_{ñ}}$), podemos transliterar bidireccionalmente del $r \bar{o} maji$ al _hiragana_/_katakana_ sin apenas errores ortográficos, agregando la enorme ventaja de tener una idea más cercana a la pronunciación correcta de las palabras en japonés.
